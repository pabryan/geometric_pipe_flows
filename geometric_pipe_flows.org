...
#+BEGIN_LATEX
\note{This entire section needs to be check over. What do I get on the boundary?}
#+END_LATEX

The last ingredient we require is a formula for differentiating under the integral sign known in the literature as the (Reynold's) Transport Theorem.  We will do this for integrals over $\disc$ and recall the standard formula here:
